...
.leabout h2::after, .leabout .h2::after {
...
.lili:hover h1, .lili:hover .h1 {
  color: #fff;
}
.lili:hover h4, .lili:hover .h4 {
  color: #fff;
}
.lili:hover p {
  color: white;
...
.firstnav button {
  ...
  color: white;
  border-radius: 20px;
  background-color: rgba(255, 160, 18, 0.897);
  border: none;
}
